...
const MyProfile = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start md:items-center bg-linear-to-b from-[#700912] via-[#c4505a] to-[#dd908c] justify-center px-6 py-12">
      {/* Modal */}
      ...
      <div
        className="relative z-10 max-w-lg w-full rounded-3xl px-8 py-6 min-h-96 overflow-auto"
        style={{
          backgroundImage: `
            radial-gradient(
              ellipse at center,
